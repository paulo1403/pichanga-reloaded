...
const Location = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full p-4 min-h-screen">
      <h1 className="text-4xl font-bold text-white mb-8 p-2 rounded">
        Ubicación
      </h1>
      <iframe
      ...
      ></iframe>
      <div className="bg-black bg-opacity-50 mt-2 p-4 rounded">
        <p className="text-white text-lg mt-4 p-2 rounded">
          Cada Sábado desde las 11 hasta la 1
        </p>
        <p className="text-white text-2xl mt-4 p-2 rounded rainbow-text">
